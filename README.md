Thanks for seeing the project. My API is running on the port: 8080  and my FrontEnd is running on the 5175 port. Of course connecting different ports could be a problem because of CORS, so I added a notation on the Spring Boot API: @CrossOrigin(origins ="*",allowedHeaders = "*").
